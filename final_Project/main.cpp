...
GLfloat position_red = 0.0f;
GLfloat speed_red = 0.06f;

void update_red(int value) {

    if(position_red >0.0)
        position_red = -0.05f;

    position_red += speed_red;

	glutPostRedisplay();


	glutTimerFunc(100, update_red, 0);
}

GLfloat position_green = 0.0f;
GLfloat speed_green = 0.06f;

void update_green(int value) {

    if(position_green >2.0)
        position_green = -2.0f;

    position_green += speed_green;

	glutPostRedisplay();


	glutTimerFunc(100, update_green, 0);
}
